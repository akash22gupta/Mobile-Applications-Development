 ...
 */
    ...
    public class AsyncDataLoaderForOnStart extends AsyncTask<String,Void,String> {
        ...
        public AsyncDataLoaderForOnStart (MainActivity ma , Stock stock) {
            mainActivity = ma;
            stockdata=stock;
        }
        ...
        protected void onPostExecute(String sb) {
            if (sb == null) {
                ...
                mainActivity.tempchooseSymbol1(tempStockObject);
            }
        }
